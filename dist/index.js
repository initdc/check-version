...
function fetchURL(url, mode, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield got_1.default(_url, options === null || options === void 0 ? void 0 : options.gotOptions);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield fetch_1.fetchURL(url, 'json');
