...
exports.regexpExec = exports.queryObject = exports.queryObjType = exports.queryType = exports.queryKeys = exports.queryKey = void 0;
function queryKey(obj, key) {
    // @ts-ignore
    return obj[key];
}
exports.queryKey = queryKey;
function queryKeys(obj, keys) {
    const arr = new Array();
    for (let key in keys) {
        // @ts-ignore
        arr.push(obj[key]);
...
function queryObjType(obj) {
    if (Array.isArray(obj)) {
        return 'array';
    }
    return 'object';
}
exports.queryObjType = queryObjType;
...
function regexpExec(str, regexp) {
    if (regexp === undefined) {
        return null;
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fetchTarget = exports.fetchOrigin = void 0;
const got_1 = __importDefault(__webpack_require__(3061));
const lodash_1 = __webpack_require__(3081);
const array_1 = __webpack_require__(5702);
async function fetchOrigin(url, mode, options) {
    if (!url) {
        return new Promise((resolve, reject) => reject(new Error('url not set')));
    }
    const _url = new URL(url);
    if (!_url) {
        return new Promise((resolve, reject) => reject(new Error('Wrong url input')));
    }
    if (!mode) {
        return new Promise((resolve, reject) => reject(new Error('mode not set')));
    }
    const response = await got_1.default(_url, options === null || options === void 0 ? void 0 : options.gotOptions);
    // console.log(response)
    switch (mode) {
        case 'json':
            const bodyObj = JSON.parse(response.body);
            const result1 = lodash_1.lodashAt(bodyObj, options === null || options === void 0 ? void 0 : options.json);
            return new Promise(resolve => resolve(result1));
            break;
        case 'regexp':
            const bodyText = response.body;
            const result2 = array_1.regexpExec(String(bodyText), options === null || options === void 0 ? void 0 : options.regexp);
...
exports.fetchTarget = fetchTarget;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.lodashAt = void 0;
const lodash_at_1 = __importDefault(__webpack_require__(7359));
function lodashAt(obj, keys) {
    return lodash_at_1.default(obj, keys);
}
exports.lodashAt = lodashAt;
...
const fetch_1 = __webpack_require__(2387);
async function run() {
    try {
...
async function test() {
    try {
        ...
        const version = await fetch_1.fetchOrigin(origin, 'json', { json: query });
        const target = 'https://api.github.com/repos/pliplive/kodbox/git/refs/tags/' + version;
        const response = await fetch_1.fetchTarget(target);
    ...
    try {
        ...
        const result = await fetch_1.fetchOrigin(url, 'full');
    ...
    try {
        ...
        const result = await fetch_1.fetchOrigin(url, 'regexp', { regexp: query });
        core.setOutput('result', result);
    }
    catch (error) {
        core.setFailed(error.message);
...
const mimicResponse = __webpack_require__(9372);
